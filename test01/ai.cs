...
(CSRight_B>40&&CSRight_B<60)))
                ...
                else if(US_Left>=0 && US_Left<=15)
                {
                    Duration = 0;
                    CurAction =10;
                }
                else if(US_Right>=0 && US_Right<=15)
                {
                    Duration = 0;
                    CurAction =11;
                }
            ...
            else if(CSLeft_R>=0 && CSLeft_R<=7 && CSLeft_G>=100 && CSLeft_G<=140 && CSLeft_B>=0 && CSLeft_B<=7&&(GreenObject<1))
            {
                Duration = 49;
                CurAction =19;
            }
...
Wheel_Right=2;
        ...
        private static void Game1()
        {
            ...
            else if((SuperObj_Num>0)&&(Object<5)&&(PositionX>SuperObj_X)&&(PositionY<SuperObj_Y))
            {
                Duration = 0;
                CurAction =1;
                if(FindObjStep==0)
...
(CSRight_B>40&&CSRight_B<60)))
                ...
                else if((PositionY>187)&&(PositionY<217)&&(PositionX>264))
                {
                    Duration = 0;
                    CurAction =32;
                }
                else if((PositionY>187)&&(PositionY<217)&&(PositionX<233))
                {
                    Duration = 0;
                    CurAction =33;
                }
                else if((PositionX>233)&&(PositionX<264)&&(PositionY<217))
                {
                    Duration = 0;
                    CurAction =34;
                }
                else if((PositionX>233)&&(PositionX<264)&&(PositionY<187))
                {
                    Duration = 0;
                    CurAction =35;
                }
            ...
            else if(CSRight_R>=220 && CSRight_R<=255 && CSRight_G>=30 && CSRight_G<=110 && CSRight_B>=220 && CSRight_B<=255&&(Object<6))
            {
                Duration = 49;
                CurAction =42;
            }
            ...
            else if(CSLeft_R>=220 && CSLeft_R<=255 && CSLeft_G>=30 && CSLeft_G<=110 && CSLeft_B>=220 && CSLeft_B<=255&&(Object<6))
            {
                Duration = 49;
                CurAction =46;
            }
            ...
            else if(CSLeft_R>=0 && CSLeft_R<=7 && CSLeft_G>=100 && CSLeft_G<=140 && CSLeft_B>=0 && CSLeft_B<=7&&(Object<6))
            {
                Duration = 49;
                CurAction =48;
            }
            else if(CSLeft_R>=110 && CSLeft_R<=170 && CSLeft_G>=0 && CSLeft_G<=10 && CSLeft_B>=0 && CSLeft_B<=10&&(Object<6))
            {
                Duration = 49;
                CurAction =49;
            }
